...
urlpatterns = [
    ...
    path('<pk>/delete/', event_manipulate_views.EventDeleteView.as_view(), name="event-delete"),
    ...
    path('place-propose/<pk>/delete/', place_proposal_views.PlaceProposalDeleteView.as_view(),
         name="place-propose-delete"),
    path('place-propose/<pk>/vote/', place_proposal_views.PlaceProposalVoteView.as_view(), name="place-propose-vote"),
    path('place-propose/<pk>/unvote/', place_proposal_views.PlaceProposalUnvoteView.as_view(),
         name="place-propose-unvote"),
    path('place-propose/<pk>/accept/', place_proposal_views.PlaceProposalAcceptView.as_view(),
